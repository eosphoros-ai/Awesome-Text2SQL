...
```
git clone https://github.com/<YOUR-GITHUB-USERNAME>/Awesome-Text2SQL
```
...
- Example: Add more dataset or base model.
...
13. Make any necessary changes based on feedback and repeat steps 4-10 until your changes are accepted and merged into the main project.
